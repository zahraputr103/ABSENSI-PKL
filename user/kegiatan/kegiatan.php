  ...
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="../kegiatan/kegiatan.php" class="active">
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Kegiatan Harian</span>
      </div>
    ...
    <div class="home-content">
        <div class="container-xl">
            <div class="table-responsive">
                ...
                <a href="addkegiatan.php"><button class="kegiatan" >+ Kegiatan</button></a>
                <div></div>
                ...
                <form class="searchBar" action="" method="post" style="margin:auto;max-width:300px" >
                    ...
                    <button type="submit" name="cari2"><i class='bx bx-search-alt'></i></button>
                </form>
                </div>
                </div>
