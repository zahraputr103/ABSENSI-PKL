...
if( isset($_POST["submit"]) ) {
    //cek data berhasil ditambahkan or no
    if(tambah($_POST) > 0){
        echo "
            <script>
...
<body id="body-pd">
        ...
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> <i class='bx bx-home nav_logo-icon'></i> <span class="nav_logo-name">Rumah IT Bandung</span> </a>
                ...
                <a href=".../dashboard/index.php" class="nav_link "> <i class='bx bx-grid-alt nav_icon'></i> <span class="nav_name">Dashboard</span> </a> 
                    <a href="../siswa/siswa.php" class="nav_link active"> <i class='bx bx-user nav_icon'></i> <span class="nav_name">Data Siswa</span> </a> 
    ...
    <h1 style="display: inline; margin: 0; padding: 0;">Data Siswa </h1>
        <p style="display: inline; margin: 0; padding: 0;">>> Tambah</p>
        <hr>
        <p><b>Tambah data siswa</b></p>
