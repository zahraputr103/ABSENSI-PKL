...
<body id="body-pd">
    ...
    <div class="height-100 bg-light">
        ...
        <div class="flex-container">
            <a href="add-siswa.php"><button class="siswa" >+ Siswa</button></a>
            <div></div>
  ...
  <tr>
    ...
    <?php foreach ($siswa as $row): ?>
        <tr>
            ...
            <td>
                <a href="up-siswa.php?siswa_id=<?= $row["siswa_id"]; ?>" style="color: blue;">Update</a> |
                <a href="../../config/hapus.php?siswa_id=<?= $row["siswa_id"]; ?>" style="color: red;" onclick="return confirm('Anda yakin akan menghapus data tersebut?')">Delete</a>
            </td>
        </tr>
        <?php $no++; ?>
        <?php endforeach; ?>
